namespace CompriaxSystem.WinFormsUI
{
    partial class FormUserProfile
    {
        ...
        private void InitializeComponent()
        {
            ...
            // pnlHeader
            pnlHeader.BackColor = Helpers.UIThemeHelper.SidebarBackground;
            ...
            lblHeaderTitle.Font = Helpers.UIThemeHelper.FontHeader;
            lblHeaderTitle.ForeColor = Color.White;
            lblHeaderTitle.Location = new Point(20, 16);
            lblHeaderTitle.Name = "lblHeaderTitle";
            lblHeaderTitle.Size = new Size(270, 30);
            lblHeaderTitle.TabIndex = 0;
            lblHeaderTitle.Text = "👤 MI PERFIL DE USUARIO";

            // pnlLeftCard
            pnlLeftCard.BackColor = Helpers.UIThemeHelper.Surface;
            ...
            Helpers.UIThemeHelper.ApplyCardStyle(pnlLeftCard);

            // picAvatar
            picAvatar.BackColor = Helpers.UIThemeHelper.Background;
            ...
            // lblNameVal
            lblNameVal.Font = Helpers.UIThemeHelper.FontHeader;
            lblNameVal.Location = new Point(10, 240);
            lblNameVal.Name = "lblNameVal";
            lblNameVal.Size = new Size(300, 25);
            lblNameVal.TabIndex = 1;
            lblNameVal.TextAlign = ContentAlignment.MiddleCenter;

            // lblRoleVal
            lblRoleVal.Font = Helpers.UIThemeHelper.FontBodyBold;
            lblRoleVal.ForeColor = Helpers.UIThemeHelper.Primary;
            ...
            // lblUserVal
            lblUserVal.Font = Helpers.UIThemeHelper.FontSmall;
            lblUserVal.ForeColor = Helpers.UIThemeHelper.TextMuted;
            ...
            // lblEmailVal
            lblEmailVal.Font = Helpers.UIThemeHelper.FontSmall;
            lblEmailVal.ForeColor = Helpers.UIThemeHelper.TextMuted;
            ...
            // pnlRightCard
            pnlRightCard.BackColor = Helpers.UIThemeHelper.Surface;
            ...
            Helpers.UIThemeHelper.ApplyCardStyle(pnlRightCard);

            // lblEditTitle
            lblEditTitle.AutoSize = true;
            lblEditTitle.Font = Helpers.UIThemeHelper.FontHeader;
            lblEditTitle.Location = new Point(24, 20);
            lblEditTitle.Name = "lblEditTitle";
            lblEditTitle.Size = new Size(328, 30);
            lblEditTitle.TabIndex = 0;
            lblEditTitle.Text = "Editar Información y Contraseña";

            // lblFirstName
            lblFirstName.AutoSize = true;
            lblFirstName.Font = Helpers.UIThemeHelper.FontBodyBold;
            ...
            lblLastName.Font = Helpers.UIThemeHelper.FontBodyBold;
            ...
            lblEmail.Font = Helpers.UIThemeHelper.FontBodyBold;
            ...
            lblCurrentPass.Font = Helpers.UIThemeHelper.FontBodyBold;
            lblCurrentPass.Location = new Point(24, 200);
            lblCurrentPass.Name = "lblCurrentPass";
            lblCurrentPass.Size = new Size(405, 21);
            ...
            lblNewPass.Font = Helpers.UIThemeHelper.FontBodyBold;
            lblNewPass.Location = new Point(24, 270);
            lblNewPass.Name = "lblNewPass";
            lblNewPass.Size = new Size(152, 21);
            ...
            lblConfirmPass.Font = Helpers.UIThemeHelper.FontBodyBold;
            lblConfirmPass.Location = new Point(290, 270);
            lblConfirmPass.Name = "lblConfirmPass";
            lblConfirmPass.Size = new Size(232, 21);
            ...
            // btnSave
            btnSave.BackColor = Helpers.UIThemeHelper.Primary;
            btnSave.FlatAppearance.BorderSize = 0;
            btnSave.FlatStyle = FlatStyle.Flat;
            btnSave.Font = Helpers.UIThemeHelper.FontBodyBold;
            ...
            BackColor = Helpers.UIThemeHelper.Background;
