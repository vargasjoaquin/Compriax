...
namespace CompriaxSystem.Application.Services
{
    public class LookupService(IUnitOfWork unitOfWork) : ILookupService
    {
        ...
        public async Task<IEnumerable<TaxCondition>> GetTaxConditionsAsync()
        {
            return await unitOfWork.GetTaxConditionsAsync();
        }
        ...
        {
          return await unitOfWork.GetGendersAsync();
        }
        ...
        public async Task<IEnumerable<CivilStatus>> GetCivilStatusesAsync()
        {
           return await unitOfWork.GetCivilStatusesAsync();
        }
        ...
        {
            return await unitOfWork.GetPositionsAsync();
        }
        ...
        {
            return await unitOfWork.GetDocumentTypesAsync();
        }
        ...
        {
            return await unitOfWork.GetPaymentMethodsAsync();
        }
    }
}